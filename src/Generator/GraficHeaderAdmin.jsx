...
function GraficHeaderAdmin() {
  ...
  useEffect(()=>{
    (async ()=>{
      ...
      console.log("tiendasssssssssssssss8",responseb);
 ...
 console.log("-------------",buys);
  ...
  return (
    <>
    <h1 className="my-5 ml-16 block text-3xl font-bold text-gray-700">Estadisticas</h1>
      ...
      <div class="flex flex-col lg:flex-row gap-5 mt-8">
        <div class="w-[250px] lg:w-[20rem]">
          ...
          <div class="border border-gray-300 rounded text-center py-8 mt-2  ">
            <h2 class="text-4xl font-bold pb-2 ">  {("$ " + total).replace(
                /(\d)(?=(\d\d\d)+(?!\d))/g,
                "$1,"
              )}</h2>
        ...
        <div class="w-full lg:w-2/5">
          ...
          <div class="flex gap-5 mt-2">
            ...
            >
              <h2 class="text-4xl font-bold pb-2">{(TotalUnidades*10)/100}%</h2>
        ...
        <div class="w-full lg:w-2/5">
          ...
          <div class="flex gap-5 mt-2">
            <div
              class="flex-grow border border-gray-300 rounded text-center py-8 w-[100px]"
            >
