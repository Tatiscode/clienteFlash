...
<section class="bg-white p-5 m-5 rounded  ">
      ...
      >
        ...
        <div class="text-center">
          <h2 class="text-4xl font-bold pb-2">0%</h2>
          <h4 class="inline text-gray-500 text-sm">This Year</h4>
        </div>
      </div>
      ...
      <div class="flex flex-col lg:flex-row gap-5 mt-8">
        <div class="w-full lg:w-1/5">
          ...
          <div class="border border-gray-300 rounded text-center py-8 mt-2">
            <h2 class="text-4xl font-bold pb-2">0</h2>
            <h4 class="inline text-gray-500 text-sm">Total Employee</h4>
          </div>
        </div>
        ...
        <div class="w-full lg:w-2/5">
          ...
          <div class="flex gap-5 mt-2">
            ...
            >
              <h2 class="text-4xl font-bold pb-2">100</h2>
              <h4 class="inline text-gray-500 text-sm">Last Year Count</h4>
            </div>
            <div
              class="flex-grow border border-gray-300 rounded text-center py-8"
            >
        ...
        <div class="w-full lg:w-2/5">
          ...
          <div class="flex gap-5 mt-2">
            ...
            >
              ...
              <h4 class="inline text-gray-500 text-sm">This Year Count</h4>
            </div>
            <div
              class="flex-grow border border-gray-300 rounded text-center py-8"
            >
              <h2 class="text-4xl font-bold pb-2">20%</h2>
              <h4 class="inline text-gray-500 text-sm">This Year %</h4>
            </div>
          </div>
        </div>
