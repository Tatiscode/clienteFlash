...
<div className="container-flecha">
        ...
        <div className="flex flex-col items-center justify-center">
          <h1 className="pb-3 text-2xl font-bold text-gray-700 mb-0">Crear una nueva contraseña para:</h1>
          <p style={{ color: "blue", marginBottom:"8px", fontSize: "15px",fontWeight: "bold" }}> {id}</p>
          <div className="campus">
            ...
            <Field type={status ? "text" : "password"} name="password" placeholder="Contaseña" />
