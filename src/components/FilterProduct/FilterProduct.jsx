    ...
    <Header/>
        ...
        {filterProduct.length > 0 ? (
         ...
         <div className="flex border shadow-xl rounded-md w-4/5 mx-auto mt-[10rem] items-center justify-center">
            <div className="">
            <svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" viewBox="0 0 24 24"><path fill="#9ca4ad" d="M15.5 14h-.79l-.28-.27A6.471 6.471 0 0 0 16 9.5A6.5 6.5 0 0 0 9.5 3C6.08 3 3.28 5.64 3.03 9h2.02C5.3 6.75 7.18 5 9.5 5C11.99 5 14 7.01 14 9.5S11.99 14 9.5 14c-.17 0-.33-.03-.5-.05v2.02c.17.02.33.03.5.03c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5z"/><path fill="#9ca4ad" d="M6.47 10.82L4 13.29l-2.47-2.47l-.71.71L3.29 14L.82 16.47l.71.71L4 14.71l2.47 2.47l.71-.71L4.71 14l2.47-2.47z"/></svg>

            </div>
            <div className=" ">
                <h1 className='font-bold text-3xl mb-2'>No hay publicaciones que coincidan con tu busqueda: {q}</h1>
                <ul>
                    <li className='text-xl'>1. Revisa la ortografía de la palabra.</li>
                    <li className='text-xl'>2. Utiliza palabras más genéricas o menos palabras.</li>
                    <li className='text-xl'>3. Navega por las categorías para encontrar un producto similar</li>
                </ul>
            </div>
            </div>
